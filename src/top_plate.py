...
def _pickup_piece():
    ...
    thread below. The -Y jack + the Y-clamp pads all live in the -Y zone, clear of the pickup."""
    ...
    # head rests on the shoulder (gravity + Y-clamp keep the load down); the screw runs

...
PARTS = {
    ...
    "kl_axle_insert": (lambda: __import__("src.knee_lever", fromlist=["e"]).kl_axle_insert(), "pctg/kl_axle_insert.step", "PCTG — knee-lever -Y AXLE INSERT ×1: Ø5 journal + 45° cone/pilot glue tenon into the hub's bed-face pocket (zero torque on this end; axially captive in its bearing pocket). Prints journal-down"),

...
PARTS = {
    ...
    "leg_shaft":       (lambda: heal(LG.leg_shaft()),   "pctg/leg_shaft.step",   "PCTG — leg sliding shaft ×4 (fine height adjust; keyed flats = pure Z travel, bottom waist mounts the pedal bar on the +Y legs). PCTG for kick-zone ductility at the waist/chord notches; standing Ø20×210 = the one slender print: brim + slow outer wall, LOW fan"),

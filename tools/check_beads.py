...
_ex("hardware",
    ...
    leg_trrs__PIN_D="the lock pin's diameter, set by the VERTICAL budget and not by a wall: groove + flange + the keeper's top have to fit inside THROAT_L, which allows 2.0 and not the 2.4 on the grid",
    leg_trrs__PIN_FIT="an INTERFERENCE, the TPU pin's squeeze in its bore -- not a length",
    leg_trrs__PIN_ENV="the groove's height: the pin's own envelope plus air, i.e. a fit on PIN_D",

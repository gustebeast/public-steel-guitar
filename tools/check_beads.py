...
_ex("hardware",
    ...
    bar_trrs__TH_APEX_PAD="DEGREES, not millimetres -- how far the bayonet entry sweeps past the build azimuth so the pocket's teardrop apex and the slot's become one apex. The bead grid has nothing to say about an angle",

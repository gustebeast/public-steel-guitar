...
_ex("hardware",
    ...
    CONN_MOUTH_X="J1 mouth position on the routed PCB (1.65 in from the -X edge)",
    CONN_PLUG_RUN="mated XH plug reach past the mouth (purchased plug envelope)",
    CONN_POCKET="clearance round J1's plug tunnel (a void, not material)",
    PCB_WZ="sensor PCB outline height (fabbed board: J1 22.4 + 1.0 edge rule x2)",

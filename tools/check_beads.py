...
_ex("hardware",
    ...
    wiring__TRRS_BASE_Z="a STATION height in the chassis, not a printed length: the tray's top and the M4's anchor set it",
    wiring__TRRS_FLOOR_Z="the cavity floor at that station, MEASURED off the built chassis",
    wiring__TRRS_PED_X1="where the electronics tray's plate edge is, measured -- a keep-out, not material",

...
_ex("hardware",
    ...
    leg_pogo__PAD_D="an ENIG pad on the PCB at the header's 2.5 pitch", leg_pogo__PAD_T="1 oz copper",
    ...
    leg_pogo__PH_S="JST ePH p.4: B4B-PH-SM4-TB overall B 11.95", leg_pogo__PH_V="...body 5.0",
    leg_pogo__PH_TAIL="...the SMT tails' (2) run",
    leg_pogo__PH_H="PHR-4's 6.85 on the header floor (floor undimensioned)",
    ...
    leg_pogo__PH_T0="the female's PH on the PCB, set by the insert's teardrop",

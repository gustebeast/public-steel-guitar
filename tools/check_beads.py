...
_ex("hardware",
    ...
    leg_pogo__PH_V="JST ePH p.4: B4B-PH-SM4-TB body depth 5.0",
    leg_pogo__PH_H="PHR-4's 6.85 on the header floor (floor undimensioned)",
    leg_pogo__PH_U="JST ePH p.4: B4B-PH-SM4-TB overall B 11.95",
    leg_pogo__PH_TAIL="JST ePH p.4: the SMT tails' (2) run",
    leg_pogo__PH_TAIL_H="the SMT tails' height off the board",
    leg_pogo__PH_BODY_H="JST ePH p.4: 6.6 tall", leg_pogo__PHR_H="JST ePH p.3: PHR-4 6.85",
    leg_pogo__PHK_U="JST ePH p.3: B4B-PH-K-S B 9.9", leg_pogo__PHK_V="...4.5 deep",
    leg_pogo__PHK_H="...6.0 tall", leg_pogo__PHK_POST="square post", leg_pogo__PHK_HOLE_D="PCB hole for it",
    leg_pogo__PHK_PROUD="JST ePH p.3: posts (3.4) below the seat, less the 1.6 board",
    leg_pogo__ARRAY_V="the pin array's place on the PCB",
    leg_pogo__BOARD_V0="PCB outline, routed by the fab",
    leg_pogo__BOARD_V1="PCB outline, routed by the fab",

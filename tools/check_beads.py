...
_ex("hardware",
    ...
    leg_trrs__LOCK_GROOVE="how deep a set screw tip sits in a groove -- a fit, and the keeper wall sets it",
    leg_trrs__LOCK_RECESS="the button head's pocket: its 2.2 height plus air, a fit on a bought head",
    leg_trrs___HEAD_R="the bought M4 button head's radius plus its air -- a fit, not a length",

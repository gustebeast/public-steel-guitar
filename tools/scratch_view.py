...
def _crop_body():
    """The whole BODY, keyhead to bridge, from a little under the legs' body stubs to over the
    strings.
    ...
    from src import dimensions as D, chassis as CH, legs as LG
    x0, x1 = D.NUT_BLOCK_X - 30.0, D.BRIDGE_BASE_X1 + 25.0
    y0, y1 = CH.Y_LO - 20.0, CH.Y_HI + 20.0
    z0, z1 = CH.Z_BOT - LG.STUB_H - 20.0, D.STRING_Z + 10.0

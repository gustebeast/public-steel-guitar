...
| **Lead screw + nut** | Tr5×1 trapezoidal (5 mm, 1 mm lead, 1-start, self-locking) — **buy ONE ≥600 mm rod and cut all ten from it**, + 10 brass nuts | 1 rod + 10 nuts | SCREW: [Amazon Tr5×1, 100–1000 mm](https://www.amazon.com/linear-motion-Printer-Stainless-Trapezoidal/dp/B0D76ZS1WD) · [RAMBEX same range](https://www.amazon.com/RAMBEX-Printer-Thread-Stainless-Trapezoidal/dp/B0D9DDN93G) · AliExpress "Tr5x1 600mm" · NUT: [uxcell Tr5×1 brass 2 pk](https://www.amazon.com/uxcell-Tr5x1-Thread-Diameter-Printer/dp/B0DS1T94C9) — ⚠️ see nut issue | **$41.45 rod** (+$39 nuts) [v 2026-08-10] | ⚠️ **OPEN ISSUE — THE NUT DOES NOT FIT, and it is the nut, not the screw.** Every stocked Tr5×1 brass nut found (VXB, uxcell/Amazon, Walmart) is the 3D-printer Z-axis style: **Ø20 flange × ~9.8 mm tall**. Our carriage is 9.0 wide in a 9.5 mm string lane and models the nut at Ø9.0 × 9.0 (`NUT_FLANGE_OD`). Ø20 cannot fit — adjacent nuts would overlap by 10 mm. The height is nearly right (9.8 vs 9.0); only the flange is wrong, and its boss may already be ≈Ø9.5, so turning/facing the flange off would be all that is needed — **but that is machining, which is ruled out: the standing constraint is NO self-machining, and outsourced parts only if low cost. Ten one-off turned nuts is not that.** Independently confirmed 2026-08-10: VXB's own listing states "Tr5X1 brass nut 9.8mm thick 20mm diameter". Searched for a plain round / unflanged Tr5x1 nut — uxcell's page 500s, RobotDigg publishes no dimensions and is inquire-only; **no in-stock unflanged Tr5x1 nut has been verified to exist.** The real options are (a) an OEM round nut, (b) a carriage that CAPTURES the Ø20 flange — adjacent lanes' flanges collide, so they would need Z-staggering — or (c) a printed/POM nut (StepperOnline sells a POM nut for Tr5x2, so Tr5x1 may be catalogue too). **This must be resolved before the carriage is final.** Plain round Tr5×1 nuts exist but only as OEM/quote items. **Do not order nuts against this row until the flange question is settled.**<br>**BUY ONE ROD, NOT TEN SCREWS — this is the whole cost story.** Verified 2026-08-10: **ASIN [B0D76YVRJD](https://www.amazon.com/dp/B0D76YVRJD) = 600 mm, Pitch 1 mm Lead 1 mm, $41.45, in stock** — one rod yields all ten screws, so the entire screw line is **$41**, about a tenth of the motor budget. Buying per-piece is the trap: the same seller's 100 mm is $25.34, i.e. **$0.25/mm against $0.069/mm for the rod — 3.7× worse**, and VXB's 100 mm piece is ~$40 (premium bearing house; availability proof, not a price). **800 mm is [B0D76Z8SWJ](https://www.amazon.com/dp/B0D76Z8SWJ) at $50.42** — worth the extra $9: ten 56.6 mm pieces plus nine saw kerfs need ~575–584 mm, leaving a 600 mm rod only ~16–25 mm of margin, versus ~220 mm on the 800. ⚠️ **Stock is THIN and fragile** — these variants show single- to low-double-digit counts and some read "Currently unavailable"; it is niche stock outside any standard supply chain, so expect listings to churn and re-verify before ordering. (One rod is what makes that survivable — shallow stock still covers a whole instrument. The nuts, needing ten, are far more exposed.) **AliExpress could not be priced: it serves an anti-bot captcha to any automated fetch**, so if it is cheaper it must be checked by hand. Cut to length — ~57 mm is not a SKU; the cut is forgiving (55–66 mm window) and Ø5 hacksaws easily. Chamfer/deburr the cut end or it chews the nut.<br>**Not a McMaster part at any length:** Ø5 trapezoidal sits *below* the ISO/DIN 103 series, which starts at **Tr8**, and we cannot go up to Tr8 because of that same 9.5 mm lane (see `SCREW_OD` in dimensions.py). *(McMaster's grid would not render for verification — the Tr8-floor reasoning is from the thread standard; confirm at purchase.)* **Ø5 is not a strength compromise** — computed at 147 N: rod tension 13.7 MPa (15× margin), thread bearing 3.1 MPa (and our duty is static holding, not traversing), drive torque 0.072 N·m (5.5× a NEMA17), lead angle 4.19° vs an 8.5° friction angle so it stays self-locking, and 2 µm of stretch = 0.4% of a semitone. It is scarce because of the standards/3D-printer market, not because it is marginal. Tr5×1 stock starts at **100 mm** and steps 100/150/200/250/300/400/500…1000 (ALM, Amazon), so every option is longer than we need. **The cut is forgiving: anything from 55 to 66 mm works** — below that the nut loses engagement at the top of travel, above it the rod fouls the changer-room ceiling; nominal **56.6** (`D.SCREW_LEN` — the single source; re-read it before ordering or cutting) sits mid-window. Hacksaw or cut-off wheel, then **chamfer and deburr the cut end** so the brass nut can start on it without being chewed. Cut length was ~61, then ~67 after the belt-plane centring, now ~57 since the screw stops 2.4 above the NUT at the top of travel instead of running to the carriage's top — that removed 10 mm of dead thread *inside the instrument*, which is what let the changer-room shelf grow; it does **not** change what is purchased (both fit a 100 mm blank). eBay listings rotate—AliExpress/ALM are stable fallbacks. **MANUAL CHECK 2026-08-01:** the eBay listing timed out on fetch and eBay item IDs rotate anyway; ALM (the manufacturer) publishes **no prices at all** — quote-only, "Inquire" button, sales@autolinearmotion.com. There is no fetchable listing for this row. |
...
~$42 at Bearings Direct), **32**× 695ZZ (**~$44** at Fast Eddy / ~$158 at Bearings Direct — the
bearing is now ONE part number for bridge + levers + pedals, and the count went
10 -> 32), 10× shaft collars (**$25**, verified), Ø5 shaft (~$30, ⚠ not re-priced), dowels (~$22), GT2 belt 6.7 m (**~$3.50–11**
...
| 3 | **Tr5×1 nut** | **(a) The NUT does not fit** — every stocked Tr5×1 nut is the Ø20-flanged 3D-printer type, and the carriage lane is 9.5. **(b) No price confirmed** — ALM is quote-only (ruled out: an open-source build must not require emailing a factory), VXB is stocked but ~$40 for one 100 mm piece, and Amazon/AliExpress both refused automated fetch | (a) measure a real nut's boss under the flange — if it is ≈Ø9.5 the fix is facing off the flange, else source a plain round nut. (b) price a **600 mm rod** (yields all ten) on Amazon/AliExpress by hand and paste the link. Do NOT price it per-piece |

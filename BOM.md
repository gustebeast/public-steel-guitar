...
| **Spring-seat / position washer** | **ISO 7093 (DIN 9021) M3 flat washer, Ø9 × 0.8, Ø3.2 hole**, steel | **44** (4 per control × 11) | ⚠ **source not yet picked** — spec it exactly; stock item | — | Two per cartridge. (1) SPRING SEAT: the tension screw's cup nests in the Ø3.2 hole (its Ø4 thread cannot pass), replacing the 3.2-long printed guide post with 0.8 of steel. (2) POSITION STOP: seated in a Ø9.4 × 0.8 recess in the housing pocket's back face, under the position screw's socket end; the 2.0 key reaches through its hole. `knee_lever.WASHER_*`. |

...
| **M4 heat-set insert** | M4 × 0.7 brass heat-set, 4.7 mm | 23 | [McMaster 94459A150](https://www.mcmaster.com/94459A150/) | $10.82 / pack 50 [m] | 10 nut clamps + 4 leg-sleeve pinch collars + 3 pickup-carrier jack nuts + 1 pickup -Y retention grub + **4 leg lock pins (in the chassis, one per corner) + 1 pedal-bar latch collar (in the bar's tower)**; deeply buried (no pull-out) |
...
| **M4 mount screw** | M4 × 0.7, 12 mm, 18-8 SS (button or socket head) | 8 | [McMaster 92095A192](https://www.mcmaster.com/92095A192/) | $14.77 / pack [m] | 4 leg-sleeve pinch bolts + **4 leg LOCK PINS** (one per corner: in through the endplate's end face, through the body adapter's tongue, into an insert in the chassis — the one screw that holds a leg on and the endplate down), into 94459A150 inserts; **M4 × 0.7** (coarse) to match the inserts — NOT the M4 × 0.5 fine-thread 90751A120. (The old "pickup X/Y clamp screw" is retired — the pickup Y-lock is now the -Y cup-tip retention grub above) |

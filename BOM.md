...
| **M4 lap screw** | M4 × 0.7, 12 mm button head, 18-8 SS | 8 | [McMaster](https://www.mcmaster.com/) | commodity | the chassis SEAM lock: 2 per rail per seam, through the −X segment's lap plate into a self-tap/insert anchor in the +X segment's rail face. This is what replaced the glued dovetail — the seams come apart with a hex key |

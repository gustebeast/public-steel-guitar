...
| **PH header**, THT top-entry 4-way | JST **B4B-PH-K-S(LF)(SN)** | 1 | price not yet read | [LCSC C131334](https://www.lcsc.com/product-detail/C131334.html) — 138,037 in stock 2026-09-21 | motor_ctrl **J2**, bus B out to the lever boards: 5 V off the controller's Pi rail (the lever boards' 24 V buck is gone), and PH so a lever harness cannot mate a 24 V XH. Mated height is an ESTIMATE (8.0) until read off JST's drawing |

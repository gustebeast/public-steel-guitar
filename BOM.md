...
| **PH header**, SMT side-entry 8-way | JST **S8B-PH-SM4-TB(LF)(SN)** | **11** | **$0.2885 @100 / $0.3344 @30** [v] | [LCSC C265121](https://www.lcsc.com/product-detail/C265121.html) — 19,469 in stock 2026-09-21 | The lever/pedal SENSOR boards' J1 (user, 2026-09-21): the lever bus runs at **5 V**, so it takes a different family from the 24 V XH motor tees — **no harness can put 24 V on a lever board**. SMT (single-sided panel, no THT step), 20.0 long on end, on the magnet face. Stock was the other reason: S8B-XH-A showed 105. Harness side = PHR-8 housing + SPH-002T-P0.5S contacts (stock not yet checked) and a PH crimp tool; **brenner's leg wiring uses PH too** (user). See `docs/lever-sensor-respin.md`. |
